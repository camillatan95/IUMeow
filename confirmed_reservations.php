...
$sql = "SELECT *
        ...
        WHERE pg.cs_id = r.cat_sitter_id AND pg.rev_id = r.reservation_id AND pg.cs_id = '$cs_user_id' AND pg.co_owner_invoice_status IS NOT NULL ORDER BY pg.rev_id DESC;";
$result = pg_query($sql);
...
End Date <input type='date' class='form-control' name='co_end_date' value='$co_end_date' readonly>
  ...
  <span class='btn btn-info text-white font-weight-bold'>Confirmed</span>
</form>
</div>
</div>
</div>
